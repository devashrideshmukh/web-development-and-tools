...
<body onload="noBack();" onpageshow="if(event.persisted) noBack();"
	...
	<div id="container">
		...
		<div id="content">
			...
			<br> <br>
			<h5>&nbsp;&nbsp; Admin Home >> Rooms And Suits >> Add Room</h5>
			<br> <br> <br> <br>
			...
			<center>
				...
				<br> <br>
				<form:form action="addRoomDetails" method="post"
					...
					<div>
						<table>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td><form:select style="style ='width: 30px'"
										path="roomType" name="roomType">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td><form:input type="text" path="pricePerDay"
										name="pricePerDay" size="10" style="height: 30px" /></td>
								<td><form:errors path="pricePerDay"
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td><form:input type="file" path="file" id="file" required="required"/></td>
								<td>Name:</td>
								<td><form:input style="height : 22px" path="image" type="text"
								required="required" name="image"/></td>
							</tr>

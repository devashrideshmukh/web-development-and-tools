			...
			<center>
				...
				<div class="wrap block-1" style="margin-left: 10%">
					<div>
						...
						<h3>Room Services</h3>
						<p>Using this service, customers can book rooms through online
							and customer can know the details of rooms alloted to them.</p>
					</div>
					<div>
						<img
					...
					<div class="last">
						...
						<p>Using this service, customers can request for tour packages
							and can also know which vehicles are alloted for them.</p>
					</div>
				</div>

...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/myTheme/CSS/Payment.css">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								...
								<h3 class="panel-title">Total Amount:
									${sessionScope.totalAmount}</h3>
							</div>
							<div class="panel-body">
								<form role="form" action="paymentConfirmation" id="payment-form">
									<div class="row">
										<div class="col-xs-12">
													...
													<div class="col-xs-7 col-md-7">
														...
														<div class="col-xs-6 col-lg-6 pl-ziro">
															<div style="padding-left: 270px" class="form-group">
																...
																<input style="height: 30px; width: 40px;"

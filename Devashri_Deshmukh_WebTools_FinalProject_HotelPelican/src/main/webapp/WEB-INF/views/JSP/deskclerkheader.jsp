...
<div class="main">
  ...
  <header>
    <div>
      <h1><a href="#"><img src="<%=request.getContextPath() %>/images/logo.jpg" alt=""></a></h1>
      <div class="social-icons"> <span>Welcome</span> <span><font style="font-size: 25px;color:white;font-weight: bold;">Pramit(DESKCLK_1)</font></span> </div>
      <div id="slide">
        <div class="slider">
          <ul class="items">
      ...
      <nav>
        <ul class="menu">
          ...
          <li><a href="<%=request.getContextPath()%>/header/deskAboutUs.jsp">Insights</a></li>
          <li><a href="<%=request.getContextPath()%>/header/deskContactUs.jsp">Contact Us</a></li>
   
          <li><a href="<%=request.getContextPath()%>/jsp/DeskGallery.jsp">Gallery</a></li>
          <li><a href="<%=request.getContextPath()%>/jsp/DeskRewards.jsp">Rewards</a></li>

		...
		<div id="content" style="float: left; margin-left: 50px;">
			...
			<div id="slide">
				<div class="slider">
					<ul class="items">
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel4.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel5.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel6.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel7.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel8.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel9.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel10.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel11.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel12.jpg alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel13.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel14.jpg" alt=""></li>
						<li><img
							src="${pageContext.request.contextPath}/resources/myTheme/IMAGES/hotel15.jpg" alt=""></li>
					</ul>
				</div>
